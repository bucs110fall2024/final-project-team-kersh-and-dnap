...
class Controller:
  ...
  def menuloop(self):
    ...
    font = pygame.font.Font(pygame.font.match_font("verdana"), 50)
    more_instruction=font.render("Jump on Red to Win!!", True, (0, 0, 0)) 
    self.screen.blit(text, (10,25))
    self.screen.blit(instruction_text, (30, 125))
    self.screen.blit(more_instruction, (150, 300))
